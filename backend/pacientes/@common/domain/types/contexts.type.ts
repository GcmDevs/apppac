...
export const ALL_CONTEXTS_WITH_AUTHORITIES = GCM_CONTEXTS_VALUES.filter(
  context => context.getCode() !== GcmContexts.EKLIPSE
);
  ...
  switch (context) {
    ...
    case GCM_CONTEXTS.ALTACENTRO: {
      if (centroId === 1)
        ...
        return { abreviattion: `AC${id || ''}`, nit: '9006124131', alias1: 'ALTA COMPLEJIDAD' };
